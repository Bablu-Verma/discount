...
const HowToWork = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-2 sm:px-4 py-14 gap-5 sm:gap-12 lg:gap-16  mb-5 flex justify-center flex-col sm:flex-row">
      <div className="flex justify-center text-start flex-col ">
        ...
        <h1 className="text-9xl font-semibold text-secondary">3</h1>
        <div>
          <p className="text-3xl font-semibold text-secondary">Easy</p>
          <p className="text-3xl font-semibold text-secondary">Steps</p>
        </div>
        </div>
      </div>
      {howwork.map((item,i) => (
