...
export async function POST(req: Request) {
  ...
  try {
    ...
    if (usertype !== "admin") {
      return new NextResponse(
        JSON.stringify({ success: false, message: "Access denied: Only admins can edit coupons" }),
    ...
    return new NextResponse(
      JSON.stringify({ success: true, message: "Coupon updated successfully.", data: coupon }),
